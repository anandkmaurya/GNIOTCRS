...
public class SQLConstant {
	...
	//AdminDAOImpl
	public static final String INSERT_COURSES = "INSERT INTO course ( course_name, course_code) VALUES ( ?, ?)";
	...
	public static final String UPDATE_ADD_GRADE ="UPDATE grades SET grades=? WHERE student_id = ? AND course_id= ? AND grade_id = ?";
;
	public static final String INSERT_ADD_GRADE = "INSERT INTO grades (student_id, grades, course_id) VALUES (?, ?, ?)";
	...
	public static final String VIEW_GRADE ="SELECT  course_code, course_name, grade_id,student_id,grades, created_at FROM course c JOIN grades g WHERE g.student_id = ? AND c.course_id= ?";
